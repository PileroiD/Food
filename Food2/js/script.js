window.addEventListener('DOMContentLoaded', () => {
    ...
    tabsParent.addEventListener('click', (event) => {
        const target = event.target;  // target - это элемент на который нажали
        console.dir(target);
    ...
    function getTimeRemaining(entime) {
        const t = Date.parse(entime) - Date.parse(new Date),
    ...
    function openModal() {
        ...
        clearInterval(modalTimerId);  // если пользователь сам открыл модальное окно, второй раз оно уже не будет отображаться
    }
